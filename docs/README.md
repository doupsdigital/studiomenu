# 📚 Documentação — StudioMenu (`studiomenu.art`)

> **Chat/agente novo neste repositório: leia primeiro [`docs/atual/ESTADO_ATUAL.md`](atual/ESTADO_ATUAL.md).**
> É o único documento com a garantia de refletir o projeto **hoje**. Tudo abaixo disso é
> histórico ou material de apoio — nenhum é instrução válida sobre o estado atual por si só.
