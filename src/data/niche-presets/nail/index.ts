...
export const nailPreset: CatalogOrderData = {
  ...
  instructions_bg_url: '/modelos/nail/assets/img/tela-orientacoes.webp',
  cta_bg_url: '/modelos/nail/assets/img/ultima-tela.webp',
  final_screen_bg_url: '/modelos/nail/assets/img/ultima-tela.webp',
  niche: 'nail',
