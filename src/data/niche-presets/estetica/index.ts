...
export const esteticaPreset: CatalogOrderData = {
  ...
  instructions_bg_url: '/modelos/estetica/assets/img/tela-orientacoes.webp',
  cta_bg_url: '/modelos/estetica/assets/img/ultima-tela.webp',
  final_screen_bg_url: '/modelos/estetica/assets/img/ultima-tela.webp',
  niche: 'estetica',
