                      ...
                      {item.edit_token && (
                        <button
                          onClick={() => {
                            ...
                            alert('🔗 Link Mágico de Edição copiado para a área de transferência!\n\n' + url);
                          }}
                ...
                <div className="pt-3 border-t border-slate-800/80 flex items-center justify-between gap-1.5 flex-wrap">
                  <div className="flex items-center gap-1.5">
                    <Link
                      href={`/c/${item.slug}`}
                      target="_blank"
                      className="px-2.5 py-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-xs font-semibold text-white flex items-center gap-1 transition-all"
                    >
                      <span>Ver</span>
                    ...
                    {item.edit_token && (
                      <Link
                        ...
                        target="_blank"
                        className="px-2.5 py-1.5 rounded-xl bg-rose-500/20 hover:bg-rose-500/30 text-rose-300 border border-rose-500/30 text-xs font-bold flex items-center gap-1 transition-all"
                      >
                        <span>Editar</span>
                      </Link>
                    )}
