...
/** Logo oficial do Google ("G" colorido), pro botão "Entrar/Vincular com
 *  Google" — mesmas 4 cores de marca em qualquer contexto (não é afetado
 *  pelo tema Rosé/Luxury do catálogo, o G do Google não muda de cor). */
export function GoogleIcon({ className = 'w-4 h-4' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <path
        fill="#FBBC05"
        d="M3.964 10.71A5.4045 5.4045 0 0 1 3.6818 9c0-.594.1023-1.1713.2822-1.71V4.9582H.9573A8.9965 8.9965 0 0 0 0 9c0 1.4523.3477 2.827.9573 4.0418L3.964 10.71z"
      />
      <path
        fill="#EA4335"
